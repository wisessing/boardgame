...
class GScipParameters(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["_heuristics", b"_heuristics", "_num_solutions", b"_num_solutions", "_objective_limit", b"_objective_limit", "_presolve", b"_presolve", "_separating", b"_separating", "_silence_output", b"_silence_output", "heuristics", b"heuristics", "num_solutions", b"num_solutions", "objective_limit", b"objective_limit", "presolve", b"presolve", "separating", b"separating", "silence_output", b"silence_output"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["_heuristics", b"_heuristics", "_num_solutions", b"_num_solutions", "_objective_limit", b"_objective_limit", "_presolve", b"_presolve", "_separating", b"_separating", "_silence_output", b"_silence_output", "bool_params", b"bool_params", "char_params", b"char_params", "detailed_solving_stats_filename", b"detailed_solving_stats_filename", "emphasis", b"emphasis", "heuristics", b"heuristics", "int_params", b"int_params", "long_params", b"long_params", "num_solutions", b"num_solutions", "objective_limit", b"objective_limit", "presolve", b"presolve", "print_detailed_solving_stats", b"print_detailed_solving_stats", "print_scip_model", b"print_scip_model", "real_params", b"real_params", "scip_model_filename", b"scip_model_filename", "search_logs_filename", b"search_logs_filename", "separating", b"separating", "silence_output", b"silence_output", "string_params", b"string_params"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType__heuristics: typing_extensions.TypeAlias = typing.Literal["heuristics"]
    _WhichOneofArgType__heuristics: typing_extensions.TypeAlias = typing.Literal["_heuristics", b"_heuristics"]
    _WhichOneofReturnType__num_solutions: typing_extensions.TypeAlias = typing.Literal["num_solutions"]
    _WhichOneofArgType__num_solutions: typing_extensions.TypeAlias = typing.Literal["_num_solutions", b"_num_solutions"]
    ...
    _WhichOneofReturnType__presolve: typing_extensions.TypeAlias = typing.Literal["presolve"]
    _WhichOneofArgType__presolve: typing_extensions.TypeAlias = typing.Literal["_presolve", b"_presolve"]
    _WhichOneofReturnType__separating: typing_extensions.TypeAlias = typing.Literal["separating"]
    _WhichOneofArgType__separating: typing_extensions.TypeAlias = typing.Literal["_separating", b"_separating"]
    _WhichOneofReturnType__silence_output: typing_extensions.TypeAlias = typing.Literal["silence_output"]
    _WhichOneofArgType__silence_output: typing_extensions.TypeAlias = typing.Literal["_silence_output", b"_silence_output"]
    @typing.overload
...
Global___GScipParameters: typing_extensions.TypeAlias = GScipParameters
...
class GScipSolvingStats(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["barrier_iterations", b"barrier_iterations", "best_bound", b"best_bound", "best_objective", b"best_objective", "deterministic_time", b"deterministic_time", "dual_simplex_iterations", b"dual_simplex_iterations", "first_lp_relaxation_bound", b"first_lp_relaxation_bound", "node_count", b"node_count", "primal_simplex_iterations", b"primal_simplex_iterations", "root_node_bound", b"root_node_bound", "total_lp_iterations", b"total_lp_iterations"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___GScipSolvingStats: typing_extensions.TypeAlias = GScipSolvingStats
...
class GScipOutput(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["stats", b"stats"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["stats", b"stats", "status", b"status", "status_detail", b"status_detail"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___GScipOutput: typing_extensions.TypeAlias = GScipOutput
