...
class Task(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["cost", b"cost", "duration", b"duration", "machine", b"machine"]
...
class Job(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["earliest_start", b"earliest_start", "latest_end", b"latest_end"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["earliest_start", b"earliest_start", "earliness_cost_per_time_unit", b"earliness_cost_per_time_unit", "early_due_date", b"early_due_date", "late_due_date", b"late_due_date", "lateness_cost_per_time_unit", b"lateness_cost_per_time_unit", "latest_end", b"latest_end", "name", b"name", "tasks", b"tasks"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class TransitionTimeMatrix(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["transition_time", b"transition_time"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___TransitionTimeMatrix: typing_extensions.TypeAlias = TransitionTimeMatrix
...
class Machine(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["transition_time_matrix", b"transition_time_matrix"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["name", b"name", "transition_time_matrix", b"transition_time_matrix"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___Machine: typing_extensions.TypeAlias = Machine
...
class JobPrecedence(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["first_job_index", b"first_job_index", "min_delay", b"min_delay", "second_job_index", b"second_job_index"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___JobPrecedence: typing_extensions.TypeAlias = JobPrecedence
...
class JsspInputProblem(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["scaling_factor", b"scaling_factor"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["jobs", b"jobs", "machines", b"machines", "makespan_cost_per_time_unit", b"makespan_cost_per_time_unit", "name", b"name", "precedences", b"precedences", "scaling_factor", b"scaling_factor", "seed", b"seed"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___JsspInputProblem: typing_extensions.TypeAlias = JsspInputProblem
...
class AssignedTask(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["alternative_index", b"alternative_index", "start_time", b"start_time"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___AssignedTask: typing_extensions.TypeAlias = AssignedTask
...
class AssignedJob(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["due_date_cost", b"due_date_cost", "sum_of_task_costs", b"sum_of_task_costs", "tasks", b"tasks"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___AssignedJob: typing_extensions.TypeAlias = AssignedJob
...
class JsspOutputSolution(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["jobs", b"jobs", "makespan_cost", b"makespan_cost", "total_cost", b"total_cost"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___JsspOutputSolution: typing_extensions.TypeAlias = JsspOutputSolution
